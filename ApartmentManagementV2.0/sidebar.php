    ...
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item <?php echo($selectedMenuName == "AnnouncementManagement" ? "active" : ""); ?>">
                <a class="sidebar-link" href="AnnouncementManagement.php">
                    <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Announcements</span>
                </a>
            </li>
            <li class="sidebar-item <?php echo($selectedMenuName == "IncomeTypeManagement" ? "active" : ""); ?>">
                <a class="sidebar-link" href="IncomeTypeManagement.php">
                    <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Income Types</span>
                </a>
            </li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="forms" class="sidebar-dropdown list-unstyled collapse" data-parent="#sidebar">
                    <li class="sidebar-item active"><a class="sidebar-link" href="forms-layouts.html">Form
                            Layouts</a></li>
