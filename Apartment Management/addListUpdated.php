    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($_POST["doorNumber"])) {
            ...
            if (!preg_match("/^[0-9-' ]*$/", $_POST["doorNumber"])) {
                ...
                $doorNumberErr = "Door number must be between 1 and 20.";
                $errorCount++;
            }
        }
        ...
        if($errorCount==0){
            ...
            $query = "INSERT INTO `resident`(`user_name`, `pass_word`, `phonenumber1`, `userrole`, `phonenumber2`, `firstname`, `lastname`, `email`, `doornumber`, `familymembercount`, `gender`) VALUES ( '".$userName."','".$md5password."','".$phoneNumber1."','".$role."','".$phoneNumber2."','".$firstName."','".$lastName."','".$email."','".$doorNumber."','".$familyMemberCount."','".$gender."')";
