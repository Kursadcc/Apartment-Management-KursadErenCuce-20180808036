...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="economy1.php">Income/Expense<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" href="economy1.php">Income</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="expense1.php">Expense</a>
  </li>
</ul>
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST" and isset($_POST["delete"])){
  ...
  if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>{$row['explanation']}</td><td >{$row['expense_date']}</td><td >{$row['expense_amount']} ₺</td></tr></br>";
    }
